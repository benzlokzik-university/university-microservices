...
class MockNotificationService:
    ...
    async def send_push_notification(
        ...
        print(f"[OneSignal] Push notification to user {user_id}: {title} - {message} ({'sent' if success else 'failed'})")
    ...
    async def send_email(
        ...
        print(f"[SendGrid] Email to {email}: {subject} ({'sent' if success else 'failed'})")
